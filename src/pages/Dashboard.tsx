    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Visão geral da sua gestão doméstica</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="bg-gradient-card shadow-custom-md">
          ...
          <CardContent>
            <div className="text-2xl font-bold">R$ {financialSummary.totalSpent.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</div>
        ...
        <Card className="bg-gradient-card shadow-custom-md">
          ...
          <CardContent>
            <div className={`text-2xl font-bold ${isOverBudget ? 'text-danger' : 'text-success'}`}>
        ...
        <Card className="bg-gradient-card shadow-custom-md">
          ...
          <CardContent>
            <div className="text-2xl font-bold">{financialSummary.percentageUsed}%</div>
                ...
                <div key={task.id} className="flex items-center justify-between p-3 rounded-lg border bg-gradient-card">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-muted-foreground">
                        {task.assignee} • {new Date(task.dueDate).toLocaleDateString('pt-BR')}
                      </p>
                    </div>
                  </div>
